...
(1, 1, 3, 'sayue', '不怎么点名，但是经常叫人起来回答问题，课的话一般吧。考试写论文，而且到交论文的时候，他会随机抽一些同学上次对自己的论文进行演讲。分数的话一会太高吧。', '写论文', 2, 3, '2013-08-04 03:21:05'),
(2, 1, 3, 'sayue', 'dsfasdfasf', 'sdfa', 1, 2, '2013-08-05 09:36:29');
...
(2, '中外广告创意赏析', '大学城校区', '人文社会科学类', '02153115', '张丽平', 'pingping112@sina.com', '13763392567', '本课程主要从广告语、平面广告、电视广告等方面比较中外广告创意的不同，并试图总结优秀广告创意的元素。在本课程中，学生将欣赏到世界一流的广告作品，同时受到创意思维的训练。', 2, 3, 5),
(3, '现代汽车构造', '大学城校区', '工程技术基础类', '16100315', '李毓洲', 'medlyz@gdut.edu.cn', NULL, '本课程是为非车辆工程专业学生开设的全校性公共选修课程。通过本课程的学习，使学生获得汽车构造的基本知识，拓宽知识面。', 3, 2, 5),
(5, '21世纪高新技术', '东风路校区', '工程技术基础类', '04101915', '曹晓国', 'xgcao@gdut.edu.cn', '13570214124', NULL, 1, 1, 2),
(6, '世界文学名著欣赏', '东风路校区', '人文社会科学类', '02111015', '唐靓', 'tj1015@21cn.com', '13560449092', '本课程选取了从古希腊《荷马史诗》到当代的《老人与海》等八部世界经典名著，通过细致的文本分析来感受文学的无穷魅力，同时探讨了人生的种种话题，如爱情、婚姻、个人奋斗、挫折磨难等问题；并对人性的种种弱点：妒忌、自负、轻信、野心等进行了深刻剖析与反省。', 4, 3, 5),
...
(11, '微量元素与生命科学', '东风路校区', '', '12112', 'sdf', NULL, NULL, NULL, 0, 0, 0),
...
(4, '3111006049', '76f5bd06cabdb7b418d41734c7250e21', '东风路校区', '2011级', 'hello', '2013-08-05 06:03:05'),
(5, '3111006047', '76f5bd06cabdb7b418d41734c7250e21', '龙洞校区', '2011级', 'world', '2013-08-05 06:03:05');
