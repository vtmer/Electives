		...
		<div class='main wrap'>
			...
			<p class='tips'>您搜索的关键字为 <strong class='key-more'><?php if(isset($none)){echo $none;} else {echo $keyword;} ?></strong> ，共有 <strong><?php if(isset($search_num)) {echo $search_num;} else {echo $num;}?></strong> 个结果！</p>
